...
/** This class specifies and verifies the correct behaviour for an instance of the TrieMap collection.
  *
  * @author hugofirth
  */
class TrieMapSpec extends UnitSpec{
  ...
  it should "be able to return the max length prefix of a given Seq[A] contained in its key set" in {
    trie maximumMutualPrefix "aced" should equal (Vector('a', 'c'))
  }
...
/** This class specifies and verifies the correct behaviour for an instance of the TrieMap collection when mixing in the
  * TrieMultiMap trait.
  *
  * @author hugofirth
  */
class TrieMultiMapSpec extends UnitSpec {
  ...
  "A TrieMultiMap" should "be able to return all sets of mappings for a given prefix" in {
